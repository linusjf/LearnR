...
# value are both objects of class pixmap; the parameter q #controls the weight of
# the noise, with the result being 1 - q times the original image plus q times
# the random noise
