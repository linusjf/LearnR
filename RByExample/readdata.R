...
# Suppose you have a file 'x.data' which looks like this: 1997,3.1,4 1998,7.2,19
# 1999,1.7,2 2000,1.1,13 To read it in --
...
main <- function(argv) {
  ...
  # The column 'year' in data frame a is accessed as a$year
